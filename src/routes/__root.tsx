...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Vikas Engineering Works | Precision Engineering Components in Pune" },
      { property: "og:description", content: "Official website of Vikas Engineering Works, Pune. Manufacturer of precision bushes, guide pins, dowel pins, piston rods, metal bolts and custom machined engineering components since 1989." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://www.vikas-engineering-works.in/" },
      { property: "og:site_name", content: "Vikas Engineering Works" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vikas Engineering Works | Precision Engineering Components in Pune" },
      { name: "twitter:description", content: "Official website of Vikas Engineering Works, Pune. Manufacturer of precision bushes, guide pins, dowel pins, piston rods, metal bolts and custom machined engineering components since 1989." },
    ...
    links: [
      { rel: "canonical", href: "https://www.vikas-engineering-works.in/" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://www.vikas-engineering-works.in/",
          founder: "Shivaji Tidke",
          foundingDate: "1989",
